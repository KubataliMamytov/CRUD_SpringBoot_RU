...
@Controller
public class EstudianteContralador {
    ...
    public String listarTodosLosEstudiantes(Model modelo) {
...
//    }
    ...
    public String crearEstudianteFormularioDeRegistrtarEstudiante(Model modelo) {
